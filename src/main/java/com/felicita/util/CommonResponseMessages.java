...
public class CommonResponseMessages {
    ...
    public static final String BAD_REQUEST_MESSAGES = "BAD_REQUEST";
    ...
    public static final int DATA_NOT_FOUND_CODE = 500;
    public static final String DATA_NOT_FOUND_STATUS = "DATA_NOT_FOUND";
