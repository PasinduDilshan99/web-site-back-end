CREATE TABLE user_notification_permission (
    ...
    new_tours_update BOOLEAN DEFAULT FALSE,
    new_tours_update_at DATETIME DEFAULT NULL,
    new_packages_update BOOLEAN DEFAULT FALSE,
    new_packages_update_at DATETIME DEFAULT NULL,
    new_destinations_update BOOLEAN DEFAULT FALSE,
    new_destinations_update_at DATETIME DEFAULT NULL,
    new_activities_update BOOLEAN DEFAULT FALSE,
    new_activities_update_at DATETIME DEFAULT NULL,
    ...
    your_tour_details_updates BOOLEAN DEFAULT FALSE,
    your_tour_details_updates_at DATETIME DEFAULT NULL,
